...
// assertEquals("core", ((WebAppContext) server.getHandler())
// .getContextPath());
// assertEquals("src/main/webapp", ((WebAppContext) server.getHandler())
// .getWar());
// }
//
// @Test
...
// assertEquals("src/main/webapp", ((WebAppContext) server.getHandler())
// .getWar());
// assertEquals("src/test/resources/web.xml", ((WebAppContext) server
// .getHandler()).getDescriptor());
// }
// }
