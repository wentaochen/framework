...
import com.weixin.protocol.message.others.SNSUserInfo;
import com.weixin.protocol.message.others.WeixinGroup;
import com.weixin.protocol.message.others.WeixinMedia;
import com.weixin.protocol.message.others.WeixinOauth2Token;
import com.weixin.protocol.message.others.WeixinQRCode;
import com.weixin.protocol.message.others.WeixinUserInfo;
import com.weixin.protocol.message.others.WeixinUserList;
...
public class AdvancedUtil {
	 ...
	 * @return
	 */
	public static String makeNewsCustomMessage(String openId, List<ResponseArticle> articleList) {
	...
	public static void main(String args[]) {
		...
		List<ResponseArticle> list = new ArrayList<ResponseArticle>();
		list.add(article1);
		list.add(article2);
		// 组装图文客服消息
