...
public class JPASchemaExport {
	...
	private static TypeFilter[] entityTypeFilters = new TypeFilter[] {
			...
			new AnnotationTypeFilter(OneToMany.class, false),
			new AnnotationTypeFilter(ManyToOne.class, false),
	...
	public static void main(String[] args) throws Exception {
		try {
			...
			AnnotationConfiguration config = new AnnotationConfiguration()
					.configure(new File(file.getAbsolutePath()+"\\src\\test\\java\\"+
							"hibernate.cfg.xml"));
			config.setProperty("output", "C:\\ddl.txt");

			String[] packagesToScan = { "com.weixin.domain.model" };
